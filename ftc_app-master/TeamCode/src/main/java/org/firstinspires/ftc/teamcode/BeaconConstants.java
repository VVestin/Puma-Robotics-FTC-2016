...
public interface BeaconConstants {
    ...
    public static final double START_SERVO_TIME = 3; // Servo to center off block
    ...
    public static final double ALIGN_POWER = 0.12; // 0.15
...
//    public static final double CR_CENTER_TIME = 1.d; //1126
    ...
    public static final double CS_BLACK_THRESHOLD = 10;
    public static final double REALIGN_TIME_THRESHOLD = 0.6;
    public static final double PUSH_BEACON_TIME = 1;
