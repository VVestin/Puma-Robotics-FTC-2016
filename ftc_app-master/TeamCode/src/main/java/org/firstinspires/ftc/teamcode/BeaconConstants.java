...
public interface BeaconConstants {
    ...
    public static final double LINE_SLOW_POWER = 0.2; // 0.1
    ...
    public static final double BEACON_FOUND_THRESHOLD = 5;
    public static final long CR_CENTER_TIME = 1126;
    public static final int SECOND_TURN_ANGLE = 80;
    public static final double FIND_BEACON_POWER = 0.15; // 0.1
    public static final double PUSH_BUTTON_POWER = 0.15; // 0.1
    public static final double CS_BLACK_THRESHOLD = 5;
    public static final double REALIGN_TIME_THRESHOLD = 1; // 0.6
    public static final double PUSH_BEACON_TIME = 2.2; // 1.5
