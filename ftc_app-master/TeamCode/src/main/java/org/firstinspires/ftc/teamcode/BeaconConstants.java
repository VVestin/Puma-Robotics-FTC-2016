...
public interface BeaconConstants {
    ...
    public static final double ALIGN_POWER = 0.13; // 0.15
    public static final double REALIGN_POWER = 0.13;
    public static final double ODS_WHITE_THRESHOLD = 0.9; // .6
    ...
    public static final double CR_CENTER_TIME = 1.4d; //1126
    ...
    public static final double PUSH_BEACON_TIME = 1; // 1.5
